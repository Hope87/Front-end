...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value === "" || materialBlock.value === "") {
      resultBlock.textContent = "Первый и второй пункты обязательны для выбора";
...
var sliders = function sliders(slidesSelector, dir, prev, next) {
  ...
  function showSlides(n) {
    ...
    items.forEach(function (item) {
      item.classList.add('animated'); //Анимация из библиотеки
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return regeneratorRuntime.awrap(resault.text());
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, ", status: ").concat(resault.status));

        case 5:
          _context2.next = 7;
          return regeneratorRuntime.awrap(resault.json());
